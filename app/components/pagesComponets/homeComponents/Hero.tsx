    ...
    <header className="my-[4rem] flex items-center min-h-[45vh] w-full md:min-h-[65vh] md:max-h-[600px] lg:min-h-[90vh]">
        <div className="md:px-[3.7rem] flex items-center justify-center md:w-full md:text-center">
            <div className="my_fixed_width lg:w-[800px]">
                ...
                <p className="text-[0.95rem] my-2 mb-7 font-rubik">Experience the benefits of effortlessly bill payments with Eversub. Save time, reduce stress and gain financial clarity. <span className="hidden md:inline">Our platform streamlines your expenses, allowing you to focus on what matters most.</span></p>
